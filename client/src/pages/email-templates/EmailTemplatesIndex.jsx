...
// Mock Data
const mockTemplates = [
    { id: 1, name: 'Welcome Email', subject: 'Welcome to Ribo CRM!', created_at: '2024-01-20T10:00:00Z' },
    { id: 2, name: 'Password Reset', subject: 'Reset your password', created_at: '2024-01-22T14:30:00Z' },
    { id: 3, name: 'Quotation Shared', subject: 'New Quote: {{quote_number}}', created_at: '2024-01-25T09:15:00Z' },
    { id: 4, name: 'Invoice Generated', subject: 'Invoice {{invoice_number}}', created_at: '2024-01-30T16:00:00Z' },
];
    ...
    return (
        ...
        >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
                                ...
                                <tr key={template.id} className="border-b hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800 transition-colors">
                                    <td className="px-4 py-3">
                                        <div className="flex items-center gap-3">
                                            <div className="h-8 w-8 rounded-full bg-amber-50 dark:bg-amber-900/30 text-amber-600 flex items-center justify-center">
                ...
                <Pagination from={1} to={data.length} total={data.length} links={[]} entityName={t("email templates")} />
            </div>
        </PageTemplate>
    );
}
