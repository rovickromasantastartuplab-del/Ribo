...
import { Layout, Type, Palette, Plus, Trash2, Star } from 'lucide-react';
import MediaPicker from '@/components/MediaPicker';

export default function FeaturesSection({ data, setData, errors, getSectionData, updateSectionData, updateSectionVisibility, t = (key) => key, brandColor }) {
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t("Features Content")}</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">{t("Features section title and description")}</p>
                    </div>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t("Features Style")}</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">{t("Background colors and section image")}</p>
                    </div>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t("Feature Boxes")}</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">{t("Individual feature items with icons")}</p>
                    </div>
                </div>
