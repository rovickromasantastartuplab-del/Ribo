...
export default function ReferralDashboard({ userType, stats, referralLink, recentReferredUsers }) {
    ...
    const copyReferralLink = async () => {
        if (referralLink) {
            ...
            setCopied(true);
            toast({ title: t('Referral link copied to clipboard') });
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="text-2xl font-bold">
                                        {Object.values(stats.monthlyReferrals || {}).reduce((a, b) => a + b, 0)}
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-2xl font-bold">
                                        ${Object.values(stats.monthlyPayouts || {}).reduce((a, b) => a + b, 0)}
                                    </div>
                                    <p className="text-sm text-muted-foreground">{t('This year')}</p>
                                </div>
                            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="mt-2 text-2xl font-bold">{formatCurrency(stats.totalEarned)}</h3>
                            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="mt-2 text-2xl font-bold">{formatCurrency(stats.availableBalance)}</h3>
                            </div>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <Button variant="outline" size="sm" asChild>
                            <a href="/referral/referred-users">
                                {t('View All')}
                            </a>
                        </Button>
                    </CardHeader>
