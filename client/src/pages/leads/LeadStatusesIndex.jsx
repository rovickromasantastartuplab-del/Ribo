...
export default function LeadStatusesIndex() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const responseData = await leadStatusService.getAll(params);

            // Handle both structure types if necessary, though typical Laravel paginate is direct properties or inside data
            ...
            toast.error(t('Failed to load lead statuses'));
            setData([]);
        } finally {
            setLoading(false);
        }
    ...
    const handleFormSubmit = async (formData) => {
        try {
            if (formMode === 'create') {
                ...
                toast.success(t('Lead status created successfully'));
            } else if (formMode === 'edit') {
                toast.loading(t('Updating lead status...'));
                await leadStatusService.update(currentItem.id, formData);
                toast.success(t('Lead status updated successfully'));
            }
    ...
    return (
        ...
        >
            ...
            <CrudFormModal
                ...
                title={formMode === 'create' ? t('Add New Lead Status') : t('Edit Lead Status')}
                mode={formMode}
            />
