...
import { RefreshCw, Users, Building2, Briefcase, TrendingUp, BarChart3, DollarSign, Target, PieChart, HardDrive } from 'lucide-react';
...
const mockDashboardData = {
    ...
    charts: {
        ...
        leadConversions: [
            ...
            { month: 'Mar', leads: 50, conversions: 35 },
            { month: 'Apr', leads: 45, conversions: 20 },
            { month: 'May', leads: 60, conversions: 40 },
            { month: 'Jun', leads: 55, conversions: 30 },
        ],
        customerDistribution: [
            { name: 'Enterprise', value: 4, color: '#8884d8' },
            { name: 'SMB', value: 10, color: '#82ca9d' },
            { name: 'Startup', value: 6, color: '#ffc658' },
        ],
    },
    recentActivities: {
        leads: [
            { name: 'John Doe', email: 'john@example.com', status: 'new', created_at: '2023-10-25T10:00:00Z' },
            { name: 'Jane Smith', email: 'jane@example.com', status: 'qualified', created_at: '2023-10-24T14:30:00Z' },
            { name: 'Bob Johnson', email: 'bob@example.com', status: 'contacted', created_at: '2023-10-23T09:15:00Z' },
        ],
        sales: [
            { customer: 'Acme Corp', amount: 5000, status: 'confirmed', created_at: '2023-10-25T11:00:00Z' },
            { customer: 'Globex Inc', amount: 2500, status: 'processing', created_at: '2023-10-24T16:45:00Z' },
        ],
        projects: [
            { name: 'Website Redesign', status: 'in_progress', created_at: '2023-10-20T10:00:00Z' },
            { name: 'Mobile App', status: 'planning', created_at: '2023-10-22T13:00:00Z' },
        ],
        customers: [
            { name: 'TechStart', type: 'startup', created_at: '2023-10-25T09:00:00Z' },
            { name: 'BigCorp', type: 'enterprise', created_at: '2023-10-24T11:30:00Z' },
        ]
    }
};
...
export default function CompanyDashboard() {
    ...
    const dashboardData = mockDashboardData; // Use mock data directly
    ...
    const getStatusColor = (status) => {
        const colors = {
            ...
            'contacted': 'bg-orange-50 text-indigo-700 ring-indigo-600/20',
        };
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-xl font-bold">${(stats.companyRevenue || 0).toLocaleString()}</h3>
                        ...
                        <Card className="hover:shadow-lg transition-shadow duration-300">
                            ...
                            <CardContent>
                                {(() => {
                                    ...
                                    const formatStorageLimit = (gb) => `${gb.toFixed(1)} GB`;
                                ...
                                {recentActivities.sales.map((sale, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-sm font-medium text-green-600">${sale.amount.toLocaleString()}</p>
                                            <p className="text-xs text-muted-foreground">
