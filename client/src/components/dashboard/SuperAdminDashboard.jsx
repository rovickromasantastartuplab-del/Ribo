...
const mockSuperAdminData = {
    ...
    recentActivity: [
        { id: 1, type: 'Subscription', message: 'New Enterprise Plan subscription', time: '2 hours ago', status: 'success' },
        { id: 2, type: 'Company', message: 'New company registration: TechFlow', time: '4 hours ago', status: 'success' },
        { id: 3, type: 'System', message: 'Database backup completed', time: '6 hours ago', status: 'success' },
        { id: 4, type: 'Support', message: 'High priority ticket #4291', time: '1 day ago', status: 'warning' },
        { id: 5, type: 'Payment', message: 'Failed payment retry for Invoice #9921', time: '1 day ago', status: 'error' },
    ],
    topPlans: [
        { name: 'Enterprise', subscribers: 45, revenue: 135000 },
        { name: 'Professional', subscribers: 85, revenue: 85000 },
        { name: 'Starter', subscribers: 15, revenue: 15000 },
    ]
};

export default function SuperAdminDashboard() {
    const { t } = useTranslation();
    const dashboardData = mockSuperAdminData;
